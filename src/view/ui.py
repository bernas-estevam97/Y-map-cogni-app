...
try:
    ...
    pass # If you are on Mac/Linux, this will just gracefully skip
...
class ToolTip:
    ...
    def show_tooltip(self, event=None):
        # Calculate tooltip position based on mouse/widget location
        ...
        self.tooltip_window.attributes("-topmost", True) # Keeps it above the main window
        
        # Using standard tk.Label for the tooltip body
...
class TrackerView(ctk.CTk):
    ...
    def __init__(self, controller):
        ...
        # --- INSTANT ICON CODE (.ico) ---
        try:
            current_dir = os.path.dirname(os.path.abspath(__file__))
            icon_path = os.path.join(current_dir, "..", "..", "img", "y-maze.ico")
    ...
    def setup_ui(self):
        ...
        self.video_listbox = tk.Listbox(self.listbox_frame, bg="#2b2b2b", fg="white", selectbackground="#1f538d", highlightthickness=0, borderwidth=0, width=35)
        ...
        # Darkness Threshold with Input Box & ToolTip
        ...
        # Minimum Area with Input Box & ToolTip
        ...
        # Maximum Area with Input Box & ToolTip
        ...
        # Execution Buttons
        self.export_btn = ctk.CTkButton(self.right_frame, text="EXPORT DATA", command=self.export_data, fg_color="#1565c0", hover_color="#0d47a1", state="disabled")
        self.export_btn.pack(pady=(15, 5), padx=20, side="bottom")

        self.stop_btn = ctk.CTkButton(self.right_frame, text="FORCE STOP", command=self.cancel_processing, fg_color="#c62828", hover_color="#b71c1c", state="disabled")
